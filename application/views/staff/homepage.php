...
<div class="col-md-10 col-md-offset-2" style="margin-top: 1%;">
    <div class="panel panel-primary">
        <div class="panel-body">
        	<div style="margin-left: 5%; margin-right: 5%;" class="table-responsive">
        		<center><h1><b>DASHBOARD</b></h1><small>New Orders</small>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="<?= base_url() . $this->session->role ?>/doAddOrder">
			      	<?php

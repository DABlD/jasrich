...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.ph/"><img src="https://raw.githubusercontent.com/hostinger/banners/master/hostinger_welcome/images/hostinger-logo.png" width="120"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="https://www.hostinger.ph/tutorials/"><i aria-hidden="true" class="fa fa-graduation-cap"></i> Tutorials</a>
                </li>
                <li>
                    <a href="https://www.hostinger.ph/make-money-online/"><i aria-hidden="true" class="fa fa-trophy"></i> Earn with us</a>
                </li>
                <li>
                    <a href="https://www.hostinger.ph/affiliate-program/login"><i aria-hidden="true" class="fa fa-user"></i> Affiliates</a>
                </li>
                <li>
                    <a href="https://cpanel.hostinger.ph"><i aria-hidden="true" class="fa fa-lock"></i> Login</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.ph/make-money-online">Learn more</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.ph/knowledge-base">Learn more</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://www.hostinger.ph/web-hosting">Web Hosting</a> |
                    <a href="https://cpanel.hostinger.ph">Client Login</a>
                </div>
